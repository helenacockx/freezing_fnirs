function [data_combi, events]=offline2online_v2(filename_online, varargin)
...
% calculate offset between 24068-24065
[corr, lags]=xcorr(ADvalues_24065(2,:), ADvalues_24068(2,:), 500);
[~, idx]=max(corr);
offset_offline=lags(idx);
fprintf('offset between the devices in the offline file was %d samples (24068-24065) \n', offset_offline)

% Calculate delay between online and offline data (24065). Approximately is
% good enough, because the data will get religned to the xsens data
% First online files trigger detection:
...
% calculate offsets between start online file and start offline file of
% 24065
offset_24065=trig_offline{1}-trig_online{1};
% offset_24068=trig_offline{2}-trig_online{2};

% use this information to calculate the offset of 24068
offset_24068=offset_24065-offset_offline;
